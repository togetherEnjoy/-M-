              ...
              >
                <div>
                  <van-swipe indicator-color="white" :autoplay="4000">
                    <van-swipe-item
                      v-for="(sw,i) in all_data_name[index].data.slice(0, 4)"
                      :key="i"
                    >
                      <div class="swip_se" @click="getDetails(sw.id)">
                        <div class="img_b">
                          <img :src="sw.coverImg" :key="i" />
                        </div>
          ...
          <van-tab :title="`房产`">
            ...
            <van-pull-refresh v-model="isLoading" @refresh="onRefresh">
              ...
              >
                <div>
                  <!-- <van-swipe indicator-color="white" :autoplay="4000">
                    <van-swipe-item v-for="(sw,i) in all_data_name[index].data.slice(0, 4)" :key="i"> 
                      <div class="swip_se" @click="getDetails(sw.id)">
                        <div class="img_b">
                          <img v-lazy="sw.coverImg" :key="i"/>
                        </div>
                        <div class="sw_mask"></div>
                        <p class="sw_txt" v-text="sw.name"></p>
                      </div>
