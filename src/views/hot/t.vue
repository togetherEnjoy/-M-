                ...
                <div>
                  <!-- <div style="width:100%">
                    <van-swipe indicator-color="white">
                      <van-swipe-item v-for="sw in list_data.slice(0, 4)">
                  ...
                  <div class="mt_swipe">
                    <mt-swipe :auto="0">
                      <mt-swipe-item v-for="sw in list_data.slice(0, 4)">
                        <div class="swip_se" @click="getDetails(sw.id)">
                          <div class="img_b">
                            <img v-lazy="sw.coverImg" />
                          </div>
...
export default {
  ...
  methods: {
    ...
    tabBtnClick(index, pageName) {
      ...
      switch (index) {
        case 0:
          this.changeTitleAndKeywords("hours");

          break;
        case 1:
          this.changeTitleAndKeywords("house");

          break;
        case 2:
          this.changeTitleAndKeywords("studytour");

          break;
        case 3:
          this.changeTitleAndKeywords("immig");

          break;
        case 4:
          this.changeTitleAndKeywords("study");

          break;
        case 5:
          this.changeTitleAndKeywords("yiliao");
