        ...
        <van-tab title="详细行程">
          <div class="xcbox">
            <div class="day" v-for="(item, i) in detailedDescription" :key="i">
              <p >
                <span class="whatday">{{ item.daytitle }}</span>
                <!-- <span class="na">{{ item.daytitle.substring(4) }}</span> -->
              </p>

              <p class="context">课程主题 | 澳洲初印象 全体学员于飞机起飞前三小时到机场集合，于机场集合出发，搭乘国际航班飞往布里斯班，启程澳大利亚亲子研学之旅！</p>
            </div>
          </div>
        </van-tab>
        <van-tab title="费用说明">
